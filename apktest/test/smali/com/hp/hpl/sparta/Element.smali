...
.method private removeChildNoChecking(Lcom/hp/hpl/sparta/Node;)Z
    ...
    iput-object v1, p0, Lcom/hp/hpl/sparta/Element;->firstChild_:Lcom/hp/hpl/sparta/Node;

    :cond_1
    iget-object v1, p0, Lcom/hp/hpl/sparta/Element;->lastChild_:Lcom/hp/hpl/sparta/Node;
    ...
    iput-object v1, p0, Lcom/hp/hpl/sparta/Element;->lastChild_:Lcom/hp/hpl/sparta/Node;

    :cond_2
    invoke-virtual {v0}, Lcom/hp/hpl/sparta/Node;->removeFromLinkedList()V

    invoke-virtual {v0, v4}, Lcom/hp/hpl/sparta/Node;->setParentNode(Lcom/hp/hpl/sparta/Element;)V

    invoke-virtual {v0, v4}, Lcom/hp/hpl/sparta/Node;->setOwnerDocument(Lcom/hp/hpl/sparta/Document;)V
...
.method private visitor(Ljava/lang/String;Z)Lcom/hp/hpl/sparta/XPathVisitor;
    ...
    const-string v1, "evaluates to element not string"
    ...
    invoke-direct {v2, v0, v1}, Lcom/hp/hpl/sparta/xpath/XPathException;-><init>(Lcom/hp/hpl/sparta/xpath/XPath;Ljava/lang/String;)V

    throw v2

    :cond_0
    const-string v1, "evaluates to string not element"

    goto :goto_0

    :cond_1
    new-instance v1, Lcom/hp/hpl/sparta/XPathVisitor;

    invoke-direct {v1, p0, v0}, Lcom/hp/hpl/sparta/XPathVisitor;-><init>(Lcom/hp/hpl/sparta/Element;Lcom/hp/hpl/sparta/xpath/XPath;)V
...
.method public cloneElement(Z)Lcom/hp/hpl/sparta/Element;
    ...
    :cond_3
    invoke-virtual {v0}, Lcom/hp/hpl/sparta/Node;->clone()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/hp/hpl/sparta/Node;

    invoke-virtual {v2, p0}, Lcom/hp/hpl/sparta/Element;->appendChild(Lcom/hp/hpl/sparta/Node;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p1, Lcom/hp/hpl/sparta/Element;->firstChild_:Lcom/hp/hpl/sparta/Node;
...
.method public xpathEnsure(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1}, Lcom/hp/hpl/sparta/xpath/XPath;->getSteps()Ljava/util/Enumeration;
    ...
    :cond_3
    invoke-virtual {v1}, Lcom/hp/hpl/sparta/xpath/XPath;->isAbsolute()Z
