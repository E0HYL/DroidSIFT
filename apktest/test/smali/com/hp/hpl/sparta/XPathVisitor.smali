...
.method private accumulateElements(Lcom/hp/hpl/sparta/Element;)V
    ...
    :cond_0
    instance-of v3, v2, Lcom/hp/hpl/sparta/Element;
    ...
    invoke-virtual {v3, v2, v4}, Lcom/hp/hpl/sparta/NodeListWithPosition;->add(Lcom/hp/hpl/sparta/Node;I)V
    ...
    :cond_2
    invoke-virtual {v2}, Lcom/hp/hpl/sparta/Node;->getNextSibling()Lcom/hp/hpl/sparta/Node;
...
.method private accumulateMatchingElements(Lcom/hp/hpl/sparta/Element;Ljava/lang/String;)V
    ...
    :cond_0
    instance-of v1, v2, Lcom/hp/hpl/sparta/Element;
    ...
    iget-object v4, p0, Lcom/hp/hpl/sparta/XPathVisitor;->nodelistRaw_:Lcom/hp/hpl/sparta/NodeListWithPosition;

    add-int/lit8 v3, v3, 0x1

    invoke-virtual {v4, v1, v3}, Lcom/hp/hpl/sparta/NodeListWithPosition;->add(Lcom/hp/hpl/sparta/Node;I)V

    :cond_1
    iget-boolean v4, p0, Lcom/hp/hpl/sparta/XPathVisitor;->multiLevel_:Z
...
.method public visit(Lcom/hp/hpl/sparta/xpath/ElementTest;)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/hp/hpl/sparta/XPathVisitor;->accumulateMatchingElements(Lcom/hp/hpl/sparta/Element;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/hp/hpl/sparta/XPathVisitor;->accumulateMatchingElements(Lcom/hp/hpl/sparta/Document;Ljava/lang/String;)V
...
.method public visit(Lcom/hp/hpl/sparta/xpath/TextEqualsExpr;)V
    ...
    iget-object v1, p0, Lcom/hp/hpl/sparta/XPathVisitor;->node_:Ljava/lang/Object;

    instance-of v1, v1, Lcom/hp/hpl/sparta/Element;

    if-nez v1, :cond_0

    new-instance v1, Lcom/hp/hpl/sparta/xpath/XPathException;

    iget-object v2, p0, Lcom/hp/hpl/sparta/XPathVisitor;->xpath_:Lcom/hp/hpl/sparta/xpath/XPath;

    const-string v3, "Cannot test attribute of document"

    invoke-direct {v1, v2, v3}, Lcom/hp/hpl/sparta/xpath/XPathException;-><init>(Lcom/hp/hpl/sparta/xpath/XPath;Ljava/lang/String;)V
    ...
    sget-object v2, Lcom/hp/hpl/sparta/XPathVisitor;->FALSE:Ljava/lang/Boolean;

    invoke-virtual {v1, v2}, Lcom/hp/hpl/sparta/XPathVisitor$BooleanStack;->push(Ljava/lang/Boolean;)V

    :goto_1
    return-void

    :cond_1
    instance-of v1, v2, Lcom/hp/hpl/sparta/Text;
    ...
    sget-object v2, Lcom/hp/hpl/sparta/XPathVisitor;->TRUE:Ljava/lang/Boolean;
...
.method public visit(Lcom/hp/hpl/sparta/xpath/TextTest;)V
    ...
    invoke-virtual {v4, v1}, Lcom/hp/hpl/sparta/NodeListWithPosition;->add(Ljava/lang/String;)V
